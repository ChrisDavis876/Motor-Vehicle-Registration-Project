<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="Certificate.aspx.cs" Inherits="Motor_Vehicle_Registration.Certificate" %>
            ...
            <asp:FormView ID="ViewCertificate" runat="server">
                <ItemTemplate>
                     <table class="auto-style1" >
                        ...
                        <tr>
                            <td class="auto-style6" colspan="2">Owner`s Name: <span style="color:red"><%#Eval("owner_name") %></span></td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style6">Expiry Date: <span style="color:red"><%#Eval("exp_date") %></span><br />
                            </td>
